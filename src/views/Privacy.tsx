...
export default function Privacy() {
  return (
    <div className="container p-6 mx-auto space-y-2">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Blockchains, Inc., 610 Waltham Way,
            Sparks, NV 89437.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to EQUS Web Wallet, accessible from{' '}
            <a
              href="https://webwallet.develop.bc-labs.dev/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://webwallet.develop.bc-labs.dev/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: dummy@blockchains.com</li>
      </ul>
    </div>
  );
}
