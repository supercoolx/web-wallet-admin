...
export default function Terms() {
  return (
    <div className="container p-6 mx-auto space-y-2">
      <ScrollToTopOnMount />

      <h1>Website Terms and Conditions of Use</h1>
      <span className="text-red-500">THIS IS DUMMY TEXT</span>

      <h2>1. Terms</h2>

      <p>
        By accessing this Website, accessible from
        https://webwallet.develop.bc-labs.dev/, you are agreeing to be bound by
      ...
      <p>
        ...
        on Blockchains, Inc.&apos;s Website for personal, non-commercial
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on Blockchains,
          Inc.&apos;s Website;
        </li>
        <li>
      ...
      <p>
        This will let Blockchains, Inc. to terminate upon violations of any of
      ...
      <p>
        All the materials on Blockchains, Inc.’s Website are provided &quot;as
        is&quot;. Blockchains, Inc. makes no warranties, may it be expressed or
        implied, therefore negates all other warranties. Furthermore,
        Blockchains, Inc. does not make any representations concerning the
      ...
      <p>
        Blockchains, Inc. or its suppliers will not be hold accountable for any
        damages that will arise with the use or inability to use the materials
        on Blockchains, Inc.’s Website, even if Blockchains, Inc. or an
      ...
      <p>
        The materials appearing on Blockchains, Inc.’s Website may include
        technical, typographical, or photographic errors. Blockchains, Inc. will
        not promise that any of the materials in this Website are accurate,
        complete, or current. Blockchains, Inc. may change the materials
        contained on its Website at any time without notice. Blockchains, Inc.
      ...
      <p>
        Blockchains, Inc. has not reviewed all of the sites linked to its
        Website and is not responsible for the contents of any such linked site.
        The presence of any link does not imply endorsement by Blockchains, Inc.
      ...
      <p>
        Blockchains, Inc. may revise these Terms of Use for its Website at any
      ...
      <p>
        Any claim related to Blockchains, Inc.&apos;s Website shall be governed
